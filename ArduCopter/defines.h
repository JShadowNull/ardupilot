...
#define FS_THR_ENABLED_LOITER_OR_ALTHOLD           8    // Loiter if GPS/position is good, else AltHold
...
#define FS_GCS_ENABLED_LOITER_OR_ALTHOLD       8    // Loiter if GPS/position is good, else AltHold
